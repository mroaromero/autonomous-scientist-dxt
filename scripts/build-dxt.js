...
`;
  ...
  async createDXTArchive() {
    ...
    console.log(`  Target path: ${this.dxtPath}`);
    ...
    return new Promise((resolve, reject) => {
      ...
      output.on('close', async () => {
        ...
        // Verify file exists
        const exists = await fs.pathExists(this.dxtPath);
        if (exists) {
          console.log(`  ✓ File verified at: ${this.dxtPath}`);
        } else {
          console.log(`  ❌ File not found at: ${this.dxtPath}`);
        }
